...
TOPIC_STATION_ARRIVAL_PREFIX = "org.chicago.cta.station.arrivals."
...
class Station(Producer):
    ...
    def __init__(self, station_id, name, color, direction_a=None, direction_b=None):
        ...
        #
        #
        topic_name = f"{TOPIC_STATION_ARRIVAL_PREFIX}.{station_name}" # TODO: Come up with a better topic name
