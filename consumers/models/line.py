...
TOPIC_STATION="org.chicago.cta.stations.table.v1"
TOPIC_STATION_ARRIVAL_PREFIX="com.udacity.ducnv104.project1.train_arrival"
TOPIC_TURNSTILE="TURNSTILE_SUMMARY"
...
class Line:
    ...
    def process_message(self, message):
        ...
        elif TOPIC_STATION_ARRIVAL_PREFIX in message_topic: # Set the conditional to the arrival topic
